...
contract Multiswap2Test is BaseTest {
    ...
    function test_multiswapRouterComponent_multiswap2_shouldRevertIfMultiswap2DataIsInvalid() external {
    ...
    function test_multiswapRouterComponent_multiswap2_shouldSwapThroughAllUniswapV2Pairs() external {
        IMultiswapRouterComponent.Multiswap2Calldata memory m2Data;
    ...
    function test_multiswapRouterComponent_multiswap2_shouldSwapThroughAllUniswapV3Pairs() external {
        IMultiswapRouterComponent.Multiswap2Calldata memory m2Data;
    ...
    function test_multiswapRouterComponent_multiswap2_shouldRevertIfAmountOutLtMinAmountOut() external {
        IMultiswapRouterComponent.Multiswap2Calldata memory m2Data;
    ...
    function test_multiswapRouterComponent_multiswap2_partswapNativeThroughV2V3Pairs() external {
        IMultiswapRouterComponent.Multiswap2Calldata memory m2Data;
    ...
    function test_multiswapRouterComponent_multiswap2_swapToNativeThroughV2V3Pairs() external {
        IMultiswapRouterComponent.Multiswap2Calldata memory m2Data;
    ...
    function test_multiswapRouterComponent_multiswap2_shouldCalculateFee() external {
        IMultiswapRouterComponent.Multiswap2Calldata memory m2Data;
    ...
    function test_multiswapRouterComponent_multiswap2_noTransferRevert() external {
        IMultiswapRouterComponent.Multiswap2Calldata memory m2Data;
