...
import { BaseTest, IERC20, Solarray, IMultiswapRouterComponent, TransferComponent } from "../BaseTest.t.sol";
...
contract MultiswapSolidlyTest is BaseTest {
    ...
    function test_multiswapRouterComponent_multiswap_solidly() external {
        ...
        _resetPrank(user);
        IERC20(tokenIn).approve({ spender: address(factory), amount: 100e18 });
        ...
        factory.multicall({
            ...
            data: Solarray.bytess(
                ...
                abi.encodeCall(TransferComponent.transferToken, (tokenOut, 0, user))
            )
        });
