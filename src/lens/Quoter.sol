...
import { IMultiswapRouterComponent } from "../components/interfaces/IMultiswapRouterComponent.sol";
import { IWrappedNative } from "../interfaces/IWrappedNative.sol";
import { IRouter } from "../components/interfaces/IRouter.sol";
...
contract Quoter is UUPSUpgradeable, Initializable, Ownable2Step {
    ...
    function multiswap(IMultiswapRouterComponent.MultiswapCalldata calldata data) external view returns (uint256 amount) {
    ...
    function multiswapReverse(IMultiswapRouterComponent.MultiswapCalldata calldata data)
        external
        view
    ...
    //// @inheritdoc IMultiswapRouterComponent
    function partswap(IMultiswapRouterComponent.PartswapCalldata calldata data) external view returns (uint256 amount) {
