...
import { IStargateComponent } from "./interfaces/IStargateComponent.sol";

/// @title StargateComponent
...
contract StargateComponent is BaseOwnableComponent, ILayerZeroComposer, IStargateComponent {
    ...
    function _validateNativeBalance(uint256 value) internal view {
        if (address(this).balance < value) {
            revert IStargateComponent.StargateComponent_InvalidNativeBalance();
        }
    }
