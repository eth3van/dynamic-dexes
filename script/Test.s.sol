...
contract Tst is Script {
    ...
    StargateComponent stargate = StargateComponent(0x387f7c5A79bCb3B5C281c505b39fd48Cec0B814C);
    ...
    function run() external {
        ...
        (,,,MessagingFee memory fee) =stargate.prepareTransferAndCall(
            ...
            abi.encode(
                ...
                abi.encodeCall(TransferComponent.transfer, (address(USDT), address(deployer), 0))
            ),
            350_000
        );
