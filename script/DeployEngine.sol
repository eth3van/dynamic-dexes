...
function getContracts(uint256 chainId) pure returns (Contracts memory) {
    ...
    if (chainId == 56) {
        return Contracts({
            multiswapRouterComponent: 0x917213eDBEF61B83bc8c80f23Ba16b60Ebe68204,
            transferComponent: 0xe536D069a426e8a8f90927e5BBf45e13Bd68f743,
            stargateComponent: 0xD2A7A4cF1B25B92f47B4A702276DefbB42F45e77,
            layerZeroComponent: 0xC2F6a6c1712899fCA57df645cfA0E9d04e0B5A38,
            symbiosisComponent: 0xf9Fe66d241BF32610a557c204a0A660348965481,
            //
            ...
            //
            prodFactory: 0x18Df5169aB4b6794cB1A61ADaf4511678e3E3e23,
            prodProxy: address(0),
            prodFeeContractProxy: address(0),
            //
    ...
    if (chainId == 137) {
        return Contracts({
            multiswapRouterComponent: 0x0112d7bBa71214056EeDAAaC031ffA56CCf1471D,
            transferComponent: 0x4FF57397049F32FB6A7c8EA65d7C1dA15b4e309B,
            stargateComponent: 0xB2C81d9cB2B3341eC5a7F42A89B59D282D8c848E,
            layerZeroComponent: 0x10255Eb3cd67406b07D6C82E69460848BCa83022,
            symbiosisComponent: 0xA429B21f896220510BA8FF26333A95a66F792621,
            //
            ...
            feeContractProxy: 0x20F282686b842851C8D7552d6fD095B55dBc775f,
            //
            prodFactory: 0xfdF5F450CF0dE94F6C0Bf0B2355de1EEb753B39D,
            prodProxy: address(0),
            prodFeeContractProxy: address(0),
            //
    ...
    if (chainId == 43_114) {
        return Contracts({
            ...
            stargateComponent: 0xF9B37dFa8479C657FddD9fB50dDb75404622EBCe,
            layerZeroComponent: 0xC0D032E84682c43e101E1e6578E0dEded5d224eD,
            symbiosisComponent: 0x62Fa7C88078BC1DE3C60A4D825891CB414C288f8,
            //
    ...
    if (chainId == 10) {
        return Contracts({
            multiswapRouterComponent: 0xFc204864E7E3a1a99504b39e18f5C7C57Eb4fEF7,
            transferComponent: 0xDF1B257a5A188132ECFaB846d5E9c67Bc17aDA73,
            stargateComponent: 0x995b74546dfa85D5147Fd0B6adCb0c83df11794b,
            layerZeroComponent: 0x10255Eb3cd67406b07D6C82E69460848BCa83022,
            symbiosisComponent: 0x14969B13A7Da9d2c25D94Dee70890A045e96F8Fb,
            //
            ...
            feeContractProxy: 0x20F282686b842851C8D7552d6fD095B55dBc775f,
            //
            prodFactory: 0x4FF57397049F32FB6A7c8EA65d7C1dA15b4e309B,
            prodProxy: address(0),
            prodFeeContractProxy: address(0),
            //
    ...
    if (chainId == 8453) {
        return Contracts({
            multiswapRouterComponent: 0x16dD0c7A5Fc23F1e6A57c32B721c0332c79ECD2D,
            transferComponent: 0x995f1B46F71Bc83a90653286e85185D27956687e,
            stargateComponent: 0xA41be65A7C167D401F8bD980ebb019AF5a7bfe26,
            layerZeroComponent: 0x3E1D733045E7abdC0bd28A272b45cC8896528bB2,
            symbiosisComponent: 0x6bF6c75738dC7114E162fB4df10ABADCF1b5bDb0,
            //
            ...
            feeContractProxy: 0x20F282686b842851C8D7552d6fD095B55dBc775f,
            //
            prodFactory: 0x07a5C075c12ffE4541F31A83531BA1d3CD1Dcbc1,
            prodProxy: address(0),
            prodFeeContractProxy: address(0),
            //
            wrappedNative: 0x4200000000000000000000000000000000000006,
