...
function getContracts(uint256 chainId) pure returns (Contracts memory) {
    ...
    if (chainId == 56) {
        return Contracts({
            ...
            //
            prodFactory: 0xC40D56c2cb35E7d0d4c1a5C313500C144b8f5AAD,
            prodProxy: address(0),
            prodFeeContractProxy: address(0),
            //
    ...
    if (chainId == 137) {
        return Contracts({
            ...
            feeContractProxy: 0x20F282686b842851C8D7552d6fD095B55dBc775f,
            //
            prodFactory: 0xDF1B257a5A188132ECFaB846d5E9c67Bc17aDA73,
            prodProxy: address(0),
            prodFeeContractProxy: address(0),
            //
    ...
    if (chainId == 43_114) {
        return Contracts({
            ...
            feeContractProxy: 0x20F282686b842851C8D7552d6fD095B55dBc775f,
            //
            prodFactory: 0x4bb53eBbBbAC038248aC3983fF9242Fa76a39C12,
            prodProxy: address(0),
            prodFeeContractProxy: address(0),
            //
    ...
    if (chainId == 10) {
        return Contracts({
            ...
            feeContractProxy: 0x20F282686b842851C8D7552d6fD095B55dBc775f,
            //
            prodFactory: 0x4b6FeDf62D61A5276e4CAf9853Ea70989cDDc967,
            prodProxy: address(0),
            prodFeeContractProxy: address(0),
            //
