...
function getContracts(uint256 chainId) pure returns (Contracts memory) {
    ...
    if (chainId == 56) {
        return Contracts({
            ...
            //
            prodFactory: 0xA7c61a0aae5e3CC3484c13B86dD39ABa80E70940,
            prodProxy: address(0),
            prodFeeContractProxy: address(0),
            //
    ...
    if (chainId == 137) {
        return Contracts({
            ...
            feeContractProxy: 0x20F282686b842851C8D7552d6fD095B55dBc775f,
            //
            prodFactory: 0xF9B37dFa8479C657FddD9fB50dDb75404622EBCe,
            prodProxy: address(0),
            prodFeeContractProxy: address(0),
            //
    ...
    if (chainId == 43_114) {
        return Contracts({
            ...
            feeContractProxy: 0x20F282686b842851C8D7552d6fD095B55dBc775f,
            //
            prodFactory: 0xf2A3Ca6cBFcF49389973FFB533180Ad82e31A180,
            prodProxy: address(0),
            prodFeeContractProxy: address(0),
            //
    ...
    if (chainId == 8453) {
        return Contracts({
            ...
            feeContractProxy: 0x20F282686b842851C8D7552d6fD095B55dBc775f,
            //
            prodFactory: 0x10255Eb3cd67406b07D6C82E69460848BCa83022,
            prodProxy: address(0),
            prodFeeContractProxy: address(0),
            //
            wrappedNative: 0x4200000000000000000000000000000000000006,
